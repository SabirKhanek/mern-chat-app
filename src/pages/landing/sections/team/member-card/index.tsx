        ...
        <div className="flex justify-center mb-3 items-center gap-2">
          {facebookLink && (
            <a href={facebookLink} target="_blank">
              <FaFacebook className="hover:text-yellow cursor-pointer"></FaFacebook>
            </a>
          )}
          {githubLink && (
            <a href={githubLink} target="_blank">
              <FaGithub className="hover:text-yellow cursor-pointer"></FaGithub>
            </a>
          )}
          {linkedinLink && (
            <a href={linkedinLink} target="_blank">
              <FaLinkedin className="hover:text-yellow cursor-pointer"></FaLinkedin>
            </a>
          )}
        </div>
      </div>
