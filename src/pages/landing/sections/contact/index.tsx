...
export default function ContactSection() {
    return (
        <section id='contact' className="bg-[#2c2c2c] py-14 relative">
            ...
            <div className=" text-[#fff] flex flex-col px-4 justify-center items-center mx-auto my-0 max-w-7xl">
                ...
                <div className='w-full px-3 sm:flex sm:justify-center'><Button className='text-black sm:!w-fit px-2 mt-6' onClick={() => { window.open('mailto:goonghaboongha@gmail.com', '_blank') }}>Email Us</Button></div>
            </div>
        </section>
    )
}