...
export function AuthUi() {
    return (
        <div className="w-full h-full bg-gradient-to-tl from-yellow-300 to-amber-400 backdrop-blur-sm justify-center items-center inline-flex">
            ...
            <div className='w-full bg-white z-10 flex items-center justify-center xs:block h-full xs:w-[420px] md:w-[500px] lg:w-[550px] xs:h-[650px] xs:rounded-lg p-5 md:p-7 lg:p-10 overflow-y-auto scrollbar'>
                <div className=''>
                    <Outlet></Outlet>
                </div>
            </div>
